...
// IMAGES
import image_01 from "../assets/images/tesis/image_01.webp";
        ...
        >
          ...
          <div className="main_background_02 uppercase text-white absolute top-0 z-10 h-full w-full flex justify-center items-end">
            <div
              data-aos="fade-right"
              data-aos-offset="100"
              className="text-center 1xl:mb-[86px] 4xl:mb-[63px]"
            >
            ...
            <div className="w-[98%] mn:w-[339px] h-[373px] sm:w-[520px] lg:w-[744px] 1xl:w-[1241px] 4xl:w-[1569px] sm:h-[563px] lg:h-[600px] 1xl:h-[402px] 4xl:h-[444px] 1xl:items-center flex flex-col 1xl:flex-row mx-auto 1xl:gap-x-[50px] gap-y-[50px]">
              ...
              >
                ...
                <p className="text-white font-semibold text-[14px] sm:text-[20px] lg:text-[25px] 4xl:text-[45px]">
                  ...
                  <span className="font-extrabold italic">TESIS</span> está
                  ...
                  <div className="h-[380px] sm:h-[600px] lg:h-[650px] 1xl:h-auto 4xl:w-[957px] flex gap-x-[42px]">
                    ...
                    <div className="text-white 1xl:w-[924px] 4xl:w-[901px] text-[12px] sm:text-[20px] lg:text-[25px] 4xl:text-[26px] font-semibold italic flex flex-col justify-between">
                      ...
                      >
                        ...
                        al obtener un título o grado que te abrirá nuevas
                        oportunidades.
                      </p>
                      <p
                        data-aos="fade-up"
            ...
            <div className="gradient_to_white pt-[100px] pb-[200px] lg:pb-[250px] 1xl:pb-[400px]">
              <div>
                ...
                <div className="mx-auto text-center mt-[150px] lg:mt-[250px] mb-[150px]">
                  ...
                  <p
                    data-aos="fade-up"
                    className="font-bold italic mx-auto w-[235px] sm:w-[339px] lg:w-[724px] lg:text[30px] 1xl:w-[839px] 4xl:w-[559px] text-[14px] sm:text-[25px] lg:text-[30px] 4xl:text-[45px]"
                  >
                ...
                <div className="flex lg:gap-x-[80px] 1xl:gap-x-[80px] w-[98%] mn:w-[340px] sm:w-[564px] lg:w-[800px] 1xl:w-[1343px] 4xl:w-[1645px] mx-auto">
                      ...
                      >
                        <div className="1xl:text-end leading-tight 1xl:w-[386px] 4xl:w-[542px] italic pr-4">
                          ...
                          <p className="sm:w-[193px] lg:w-auto font-semibold text-[12px] sm:text-[15px] lg:text-[18px] 4xl:text-[25px]">
                            Los temas son personalizados y acordes a tu problema
                            de investigación.
                          </p>
                        </div>
                    ...
                    <div className="flex flex-col justify-between w-[80%] mn:w-auto  1xl:h-[299px] 4xl:h-[319px] arrow_list_tsp_02">
                      ...
                      >
                        ...
                        <div className="leading-tight italic text-end 1xl:text-start pl-6">
                          ...
                          <p className="font-semibold text-[10px] sm:text-[15px]  lg:text-[18px] 4xl:text-[25px] 1xl:w-[416px] 4xl:w-[559px]">
                            Desarrollo de la tesis desde la introducción hasta
            ...
            <div className="gradiend_to_top pb-[20px]">
              <div className="">
                ...
                <div className="pt-[30px] space-y-10">
                  ...
                  <div className="hidden sm:block lg:w-[600px] space-y-[50px] 1xl:space-y-0 1xl:w-[1280px] 4xl:w-[1500px] 1xl:flex flex-wrap gap-10 justify-center mx-auto">
                    ...
                    >
                      <img
                        src={icono_14}
                        className="1xl:w-[58px] 1xl:h-[60px] 4xl:w-[78px] 4xl:h-[67px]"
                        alt="icono_14"
                      />
                ...
                <div className="text-white font-extrabold uppercase space-y-10 w-[95%] mn:w-[340px] sm:w-[495px] lg:w-[720px] 1xl:w-[941px] 4xl:w-[1086px] mx-auto mt-[150px] lg:mt-[250px]">
                  ...
                  >
                    ¡No esperes más para finalizar tu Tesis!
                  </h2>
                  <button
                    onClick={handleContact}
                    data-aos="fade-up"
                ...
                <div className="w-[95%] mx-auto mn:w-[339px] sm:w-[515px] lg:w-[743px] 1xl:w-[1241px] 4xl:w-[1500px] mt-[150px] lg:mt-[250px] 1xl:mt-[400px] space-y-[140px]">
                  ...
                  <div className=" flex flex-col gap-y-[50px] mn:gap-y-[100px] 1xl:flex-row 1xl:items-center 4xl:items-start 1xl:h-[380px] 4xl:h-[508px]  1xl:gap-x-[88px] 4xl:gap-x-[61px]">
                    <p
                      data-aos="fade-up"
                      className="text-[14px] sm:text-[20px] lg:text-[25px] 4xl:text-[30px] mn:w-[263px] sm:w-[409px] lg:w-[463px] 1xl:w-[593px] 4xl:w-[711px] text-white italic font-semibold text-justify sm:text-start"
                    >
                      ...
                      >
                        <p>
                          <span className="text-[#0CB2D5] uppercase">
                            Tu tesis en las mejores manos:
                          </span>{" "}
                          Profesionales en investigación académica, egresados de
                          universidades de prestigio y con amplia experiencia en
                          asesoría de tesis.
                        </p>
                        <p>
                          <span className="text-[#0CB2D5] uppercase">
                ...
                <div className="mt-[200px] lg:mt-[350px] space-y-[150px]">
                  <div className="italic space-y-[20px] w-[274px] sm:w-[386px] lg:w-[740px] 1xl:w-[898px] 4xl:w-[905px] mx-auto text-center">
                    ...
                    >
                      Déjanos ayudarte a finalizar tu tesis de manera exitosa.
                    </p>
                  </div>
                      ...
                      >
                        <div className="flex mn:gap-x-[10px] sm:gap-x-[10px] sm:w-[400px] h-[150px] sm:h-[150px] lg:h-[180px] lg:w-[544px] 1xl:w-[484px] 4xl:w-[583px] 1xl:h-[160px] 4xl:h-[277px] 1xl:gap-x-[10px] lg:gap-x-[10px]">
                          ...
                          <div className="flex flex-col justify-between">
                            <p className="text-md w-[240px] sm:w-[300px] lg:w-[484px] text-[14px] sm:text-[14px] lg:text-[20px] 1xl:text-[20px] 4xl:text-[30px] text-white font-bold leading-tight relative">
                              Su guía y apoyo constante fueron fundamentales
                              para alcanzar mis objetivos{" "}
                              <span className="relative">
                                académicos.
                                <span className="absolute rotate-180 -right-3 lg:-right-5 translate-x-full">
                                  {" "}
                                  <ImQuotesLeft className="quote overflow-visible size-[20px] sm:size-[30px] 1xl:size-[40px] lg:size-[30px] 4xl:size-[40px]" />
                                </span>
                              </span>
                    ...
                    <div className="space-y-10">
                      ...
                      >
                        <div className="flex mn:gap-x-[10px] sm:gap-x-[10px] sm:w-[400px] h-[150px] sm:h-[150px] lg:h-[180px] lg:w-[544px] 1xl:w-[484px] 4xl:w-[583px] 1xl:h-[160px] 4xl:h-[277px] 1xl:gap-x-[10px] lg:gap-x-[10px]">
                          ...
                          <div className="flex flex-col justify-between">
                            <p className="text-md w-[240px] sm:w-[300px] lg:w-[484px] text-[14px] sm:text-[14px] lg:text-[20px] 1xl:text-[20px] 4xl:text-[30px] text-white font-bold leading-tight relative">
                              El centro Alejandría me proporcionó las
                              herramientas y el conocimiento necesarios. Mi
                              trabajo final fue un éxito rotundo, y estoy muy
                              agradecida por su{" "}
                              <span className="relative">
                                profesionalismo
                                <span className="absolute rotate-180 -right-4 lg:-right-5 translate-x-full">
                                  {" "}
                                  <ImQuotesLeft className="quote overflow-visible size-[20px] sm:size-[30px] 1xl:size-[40px] lg:size-[30px] 4xl:size-[40px]" />
                                </span>
                              </span>
            ...
            <div className="bg-white mb-[200px] lg:mb-[600px]">
              <div className="w-[95%] mn:w-[340px] sm:w-[520px] lg:w-[720px] 1xl:w-[909px] 4xl:w-[1397px] space-y-[50px] lg:space-y-[100px] mx-auto text-center">
                ...
                <button
                  ...
                  data-aos="fade-up"
                  data-aos-offset="100"
                  className="1xl:text-[30px] block text-white font-extrabold uppercase bg-[#FCB400] rounded-full w-full mn:w-[340px] h-[40px] sm:w-[520px] sm:h-[60px] lg:w-[720px] lg:h-[80px] 4xl:w-[800px] 4xl:h-[100px] mx-auto"
                >
                  ¡Únete hoy!
                </button>
              </div>
