...
import icono_10 from "../assets/icons/tsp/icono_15.svg";
import CarouselMarquee from "../components/CarouselMarquee";
import { ImQuotesLeft } from "react-icons/im";

const ArticuloCientifico = () => {
  const handleContact = () => {
  ...
  return (
    <LayoutApp>
      <main className="overflow-hidden">
        ...
        >
          <img
            src={backgroundArticuloCientifico}
          ...
          <div className="new pt-[173px]">
            <div className="w-[98%] mn:w-[339px] h-[373px] sm:w-[520px] lg:w-[744px] 1xl:w-[1241px] 4xl:w-[1569px] sm:h-[563px] lg:h-[600px] 1xl:h-[402px] 4xl:h-[444px] 1xl:items-center flex flex-col 1xl:flex-row mx-auto 1xl:gap-x-[50px] gap-y-[50px]">
              <div
                data-aos="fade-right"
                data-aos-offset="100"
                className="sm:w-[447px] lg:w-[557px] 1xl:w-[548px] 4xl:w-[660px] leading-normal"
              >
              ...
              <div className="flex flex-1 gap-x-[16px] sm:gap-x-[35px] lg:gap-x-[63px] 1xl:gap-x-[51px] 4xl:gap-x-[57px] text-center h-full">
                <div
                  data-aos="flip-left"
                  data-aos-offset="100"
                ...
                >
                  <img
                    ...
                    alt="icono_02"
                  />
                  <p className="text-white leading-none font-bold text-[11px] mn:text-[13px] sm:text-[18px] 4xl:text-[25px] italic 4xl:w-[119px]">
                    Reducir el estrés
                  </p>
                </div>
                <div
              ...
              <div className="pt-[150px] lg:pt-[300px]  w-[95%] mn:w-[339px] sm:w-[520px] lg:w-[744px] 1xl:w-[1286px] 3xl:w-[1518px] mx-auto space-y-[100px] mb-[200px] lg:mb-[250px] 1xl:mb-[400px]">
                ...
                >
                  <h3 className="text-[#0CB2D5] uppercase text-[16px] sm:text-[20px] lg:text-[25px] 4xl:text-[35px]">
                    Más que un artículo científico:
                  </h3>
                  ...
                  <div className="h-[380px] sm:h-[600px] lg:h-[650px] 1xl:h-auto 4xl:w-[957px] flex gap-x-[42px]">
                    ...
                    <div className="text-white 1xl:w-[924px] 4xl:w-[901px] text-[12px] sm:text-[20px] lg:text-[25px] 4xl:text-[26px] font-semibold italic flex flex-col justify-between">
                      ...
                      >
                        ...
                        al publicar un artículo científico que te abrirá nuevas
                      ...
                      >
                        ...
                        aspecto de tu artículo científico.
                      </p>
                      <p
                        data-aos="fade-up"
                        data-aos-offset="150"
                      ...
                      >
                        ...
                        al alcanzar una de las metas más importantes de tu
                        carrera.
                      </p>
                      <p
                        data-aos="fade-up"
            ...
            <div className="gradient_to_white pt-[100px] pb-[200px] lg:pb-[250px] 1xl:pb-[400px]">
              <div>
                <div className="space-y-[47px] w-[95%] mn:w-auto mx-auto">
                  <h3
                    data-aos="fade-up"
                    className="uppercase font-extrabold text-[16px] sm:text-[25px] lg:text-[30px] mn:w-[340px] sm:w-[564px] lg:w-[649px] 1xl:w-[1151px] 4xl:w-[1402px] mx-auto 4xl:text-[40px] italic text-center"
                  >
                    ¿Listo para llevar tu artículo científico al siguiente
                    nivel?
                  </h3>
                  <button
                    onClick={handleContact}
                    data-aos="fade-up"
                    className="italic uppercase text-white bg-[#FCB400]  font-extrabold  w-full mn:w-[340px] h-[40px] sm:w-[520px] sm:h-[60px] sm:text-[18px] lg:w-[825px] lg:h-[80px] 4xl:h-[100px] 4xl:w-[913px] text-[12px] lg:text-[25px] 1xl:text-[30px] rounded-full mx-auto block"
                  >
                    ¡quiero empezar con mi artículo!
                  </button>
                </div>
                  ...
                  <div className="flex-1 space-y-[120px]">
                    <div className="flex flex-col justify-between 1xl:h-[299px] 4xl:h-[319px] arrow_list_tsp_02_r">
                      ...
                      <div
                        ...
                        className="flex flex-col-reverse w-[80%] mn:w-auto ml-4 mn:ml-0 1xl:flex-row justify-end 1xl:gap-x-[25px] 4xl:gap-x-[30px] mt-[50px]"
                      >
                        <div className="1xl:text-end leading-tight 1xl:w-[386px] 4xl:w-[542px] italic  pr-4">
                          ...
                          <p className="sm:w-[193px] lg:w-auto font-semibold text-[12px] sm:text-[15px] lg:text-[18px] 4xl:text-[25px]">
                            Los temas son personalizados y acordes a tu
                            especialidad y experiencia laboral.
                          </p>
                        </div>
                    ...
                    <div className="flex flex-col justify-between ">
                      ...
                      >
                        <img
                          src={icono_10}
                          className="lg:w-[45px] lg:h-[45px] p-3 lg:p-0"
                          alt="icono_04"
                        />
                      </div>
                    </div>
                  ...
                  <div className="flex-1 space-y-[120px] ">
                      ...
                      >
                        ...
                        <div className="leading-tight italic text-end 1xl:text-start pl-6">
                          ...
                          <p className="font-semibold text-[12px] sm:text-[15px] lg:text-[18px] 4xl:text-[25px] 1xl:w-[416px] 4xl:w-[559px]">
                            Desarrollo del artículo científico desde la
                            introducción hasta las referencias bibliográficas.
                          </p>
                        </div>
                      </div>
                      <div
                    ...
                    <div className="flex flex-col justify-between w-[80%] mn:w-auto 1xl:h-[299px] 4xl:h-[319px] arrow_list_tsp_02">
                      ...
                      >
                        <img
                          src={icono_09}
                          className="sm:w-[50px] lg:w-[45px] lg:h-[45px] p-2 lg:p-0"
                          alt="icono_09"
                        />
                      </div>
                    </div>
                    <div className="flex flex-col justify-between w-[80%] mn:w-auto arrow_list_tsp_02">
                      <div
                        data-aos="zoom-in-up"
                        className="flex flex-col 1xl:flex-row gap-x-6 "
                      >
                        ...
                        <div className="leading-tight italic text-end 1xl:text-start pl-6">
                          ...
                          <p className="font-semibold text-[12px] sm:text-[15px] lg:text-[18px] 4xl:text-[25px] 1xl:w-[416px] 4xl:w-[468px]">
                            Gestionamos tu artículo para que sean publicadas en
                            revistas indexadas en Scopus, SciELO, WOS y más.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="gradiend_to_top pb-[20px]">
              <div className="">
                <h2 className="text-[#0CB2D5] invisible font-extrabold italic text-[16px] sm:text-[25px] lg:text-[30px] 4xl:text-[40px] text-center ">
                  ¡AÚN HAY MÁS…..!
                </h2>

                <div className=" text-white font-extrabold uppercase space-y-10 w-[95%] mn:w-[340px] sm:w-[495px] lg:w-[720px] 1xl:w-[941px] 4xl:w-[1086px] mx-auto mt-[150px] lg:mt-[330px]">
                  <h2
                    data-aos="fade-up"
                    className="text-center text-[16px] sm:text-[25px] lg:text-[30px] 4xl:text-[35px]"
                  >
                    ¡no esperes más para finalizar tu artículo científico!
                  </h2>
                  <button
                    onClick={handleContact}
                    data-aos="fade-up"
                      ...
                      >
                        <p>
                          <span className="text-[#0CB2D5] uppercase">
                            Tu artículo científico en las mejores manos:
                          </span>{" "}
                          Profesionales en artículos científicos, egresados de
                          universidades reconocidas, con un amplio conocimiento
                          en la redacción y publicación de sus propios artículos
                          y de terceros.
                        </p>
                        <p>
                          <span className="text-[#0CB2D5] uppercase">
                ...
                <div className="mt-[200px] lg:mt-[350px] space-y-[150px]">
                  <div className="italic space-y-[20px] w-[274px] sm:w-[386px] lg:w-[740px] 1xl:w-[898px] 4xl:w-[905px] mx-auto text-center">
                    ...
                    >
                      Déjanos ayudarte a finalizar tu artículo científico de
                      manera exitosa.
                    </p>
                  </div>
                        ...
                        <div className="flex mn:gap-x-[10px] sm:gap-x-[10px] sm:w-[400px] h-[150px] sm:h-[150px] lg:h-[180px] lg:w-[544px] 1xl:w-[484px] 4xl:w-[583px] 1xl:h-[160px] 4xl:h-[277px] 1xl:gap-x-[10px] lg:gap-x-[10px]">
                          ...
                          <div className="flex flex-col justify-between">
                            <p className="text-md w-[240px] sm:w-[300px] lg:w-[484px] text-[14px] sm:text-[14px] lg:text-[20px] 1xl:text-[20px] 4xl:text-[30px] text-white font-bold leading-tight">
                              Su apoyo fue esencial para estructurar mis ideas
                              con claridad en mi artículo. Muy agradecido por su
                    ...
                    <div className="space-y-10">
                      ...
                      >
                        <div className="flex mn:gap-x-[10px] sm:gap-x-[10px] sm:w-[400px] h-[150px] sm:h-[150px] lg:h-[180px] lg:w-[544px] 1xl:w-[484px] 4xl:w-[583px] 1xl:h-[160px] 4xl:h-[277px] 1xl:gap-x-[10px] lg:gap-x-[10px]">
                          ...
                          <div className="flex flex-col justify-between">
                            <p className="text-md w-[240px] sm:w-[300px] lg:w-[484px] text-[14px] sm:text-[14px] lg:text-[20px] 1xl:text-[20px] 4xl:text-[30px] text-white font-bold leading-tight">
                              Gracias a Alejandría, mi investigación avanzó
                              significativamente, abordando mis hipótesis con
                              rigor y presentando resultados{" "}
                              <span className="relative">
                                convincentes.
                                <span className="absolute rotate-180 -right-2 lg:-right-5 translate-x-full">
                                  {" "}
...
export default ArticuloCientifico;
